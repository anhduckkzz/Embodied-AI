...
as a disposable generated template. The detailed quality standard lives in
[`curriculum/NOTEBOOK_GUIDE.md`](curriculum/NOTEBOOK_GUIDE.md), and focused
execution paths live in [`quickstart_tracks.md`](quickstart_tracks.md). A good
notebook includes:
